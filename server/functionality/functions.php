...
function kraske_react_2016_setup() {
	 ...
	 */
	load_theme_textdomain( 'kraske-react-2016', get_template_directory() . '/languages' );
 ...
 */
function kraske_react_2016_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'kraske-react-2016' ),
		'id'            => 'sidebar-1',
		'description'   => esc_html__( 'Add widgets here.', 'kraske-react-2016' ),
...
add_action( 'widgets_init', 'kraske_react_2016_widgets_init' );
...
function kraske_react_2016_scripts() {
	...
	wp_enqueue_script( 'kraske-react-2016-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'kraske-react-2016-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
